            ...
            <Navbar>
                <main className="flex min-h-screen w-screen flex-col items-center justify-between p-24 bg-white md:w-full">
                    <div className="flex flex-col bg-[url('/bg1.png')] m-5 p-5 gap-5 rounded-md w-screen md:w-full">
                        <div className=' text-3xl font-bold justify-between items-center text-center w-screen md:w-full'>{" "} MTBS </div>
                        <div className=' text-3xl font-bold justify-between items-center text-center w-screen md:w-full'>{" "} PUSKESMAS KLUMBAYAN BARAT</div>
                        {renderContent()}
                    </div>
                </main>
            </Navbar>
