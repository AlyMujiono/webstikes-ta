    ...
    <div className="flex flex-col w-screen md:w-full">
      <Navbar>
        <main className="flex min-h-screen w-screen flex-col items-center justify-between p-24 bg-white  md:w-full">
          <div className="flex flex-col m-5 p-5 gap-5 rounded-md w-screen md:w-full">
            <div className="flex justify-center w-screen mx-10 min-h-fit md:w-full">
              <div className="flex justify-start items-start w-screen md:w-full">
                <Image
                  alt="Login"
                  src={
                    section === 1
